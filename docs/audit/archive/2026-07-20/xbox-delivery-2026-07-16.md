...
### 1. 架构巡检（架构师 · 部分工作流）
- 交付 `docs/architecture/architecture_review.md`：22 项风险（P0×3 / P1×8 / P2×11）。
- 根因聚焦：
...
- 拓扑：`docs/architecture/architecture_current_topology.mmd`、`docs/architecture/architecture_target_topology.mmd`。
...
- 改动：
  ...
  - 新增 `docs/deployment/prod-mac-runbook.md`（8 节：前置/凭证契约/启动命令/验证/已知手动步骤/Ollama-CPU 提醒/GBK 转码/禁止改动清单）。
...
- `D:/crh123dexiaohao/X-box/docs/audit/archive/2026-07-14/docs/X-box-p0-remediation-log-2026-07-14.md`
- `D:/crh123dexiaohao/X-box/docs/audit/archive/2026-07-14/docs/X-box-p0-qa-verification-2026-07-14.md`
- `D:/crh123dexiaohao/X-box/docs/audit/archive/2026-07-14/docs/X-box-db-merge-log-2026-07-14.md`
- `D:/crh123dexiaohao/X-box/docs/architecture/architecture_review.md`

### 新建
- `D:/crh123dexiaohao/X-box/docs/deployment/prod-mac-runbook.md`
...
3. 按 `docs/audit/archive/2026-07-14/docs/X-box-db-merge-runbook-2026-07-14.md` 手动建 `class_user` 及 `msg`/`work` 库。
