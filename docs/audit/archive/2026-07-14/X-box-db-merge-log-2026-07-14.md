...
| `docs/audit/archive/2026-07-14/docs/X-box-db-merge-runbook-2026-07-14.md` | 新建 | — | 建库/账号/授权/密码对齐/迁移/回滚手册 | 运维执行依据 |
...
- 按 `docs/audit/archive/2026-07-14/docs/X-box-db-merge-runbook-2026-07-14.md` 在 dev-mysql 运行时执行建库/账号/授权/密码对齐/迁移。
...
### E1-4 — `docs/audit/archive/2026-07-14/docs/X-box-db-merge-runbook-2026-07-14.md` 启动命令统一
...
- `grep -n "docker compose" docker-compose.prod.yml docs/audit/archive/2026-07-14/docs/X-box-db-merge-runbook-2026-07-14.md` → 三处启动命令均含 `-f docker-compose.base.yml -f docker-compose.prod.yml --env-file .env.prod`。
