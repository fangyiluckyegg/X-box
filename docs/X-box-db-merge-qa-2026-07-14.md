...
### S7 — runbook / log 文档完整
- **实际取证**：
  - `docs/X-box-db-merge-runbook-2026-07-14.md` 含建库(§1)/账号(§2)/改密(§4)/GRANT(§3)/迁移(§5)/回滚(§6) ✓
  - `docs/X-box-db-merge-log-2026-07-14.md` 含「二轮返工 F1/F2」小节（§39–64）✓
- **判定：PASS**
...
### T3 — 启动命令三处统一且完整
- 取证：`grep -n "docker compose" docker-compose.prod.yml docs/X-box-db-merge-runbook-2026-07-14.md`（Read 确认 19/27 行）
  ...
  - `docs/X-box-db-merge-runbook-2026-07-14.md:17` → 同上完整命令 ✓
