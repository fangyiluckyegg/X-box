...
<div id="box">
  ...
  <div id="pic1">
    ...
    <div id="right">
      <div id="title"><span class="font01">共有 <?php echo $totalRows_rspic ?> 个作品，当前显示第 <?php echo ($startRow_rspic + 1) ?> 个至第 <?php echo min($startRow_rspic + $maxRows_rspic, $totalRows_rspic) ?> 个</span>全部设计作品</div>
      <div id="pic-work">
        <?php if ($totalRows_rspic > 0) { ?>
          <?php do { ?>
            <div class="work1"><a href="work-show.php?p_id=<?php echo $row_rspic['p_id']; ?>" target="_blank"><img src="admin/upload/<?php echo $row_rspic['p_src']; ?>" alt="" width="195" height="122"></a><br>
              <span class="font02"><?php echo $row_rspic['p_name']; ?></span><br>
              [<?php echo $row_rspic['t_name']; ?>]　<?php echo $row_rspic['p_date']; ?></div>
