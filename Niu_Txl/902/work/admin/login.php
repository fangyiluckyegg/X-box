...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginSuccess = "admin-work.php";
...
<div id="login">
  <form ACTION="<?php echo $loginFormAction; ?>" id="form1" name="form1" method="POST">
    <input name="username" type="text" required class="input01" id="username" placeholder="请输入管理员账号">
    <br>
    <input name="password" type="password" required class="input01" id="password" placeholder="请输入管理员密码">
    <br>
    <input type="image" name="btn" id="btn" src="images/loginbtn.jpg">
  </form>
</div>
</body>
</html>
