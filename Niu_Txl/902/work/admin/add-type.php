...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO work_type (t_name) VALUES (%s)",
                       GetSQLValueString($_POST['type_name'], "text"));

  mysql_select_db($database_conn, $conn);
  $Result1 = mysql_query($insertSQL, $conn) or die(mysql_error());

  $insertGoTo = "admin-type.php";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <div id="pic1">
    ...
    添加作品分类</div>
      <div id="pic-work">
        ...
        <ul>
          <li>作品分类名称：
            <input name="type_name" type="text" required class="input01" id="type_name" placeholder="请输入分类名称">
          </li>
          <li>
